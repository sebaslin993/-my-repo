...
int main()
{
    LOGI("TouchEvents - WebGL / Emscripten (GLFW)");
    ...
    g_window = glfwCreateWindow(800, 600, "TouchEvents", nullptr, nullptr);
...
int main()
{
    LOGI("TouchEvents - WebGL / Emscripten (SDL2)");
...
int main()
{
    std::cout << "TouchEvents – Desktop (GLFW)\n";
    std::cout << "Left-click: red | Drag: green | Release: blue\n";
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "TouchEvents", nullptr, nullptr);
    if (!window) {
